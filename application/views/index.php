...
<div id="page">
					...
					<nav class="nav row">
						<div class="col-sm-5">
							<ul class="navigation left-nav">
								<li class='current'><a class='current' href="<?php echo base_url(); ?>home/tema">Inicio</a></li>
								<!--<li><a href="index_alt.html">Home 2</a></li>-->
								<li><a href="listing-3col.html">Listado</a>
									<ul>
										<li><a href="listing-4col.html">Listado 4 Columnas</a></li>
									</ul>
								</li>
								<li><a href="room.html">Habitación Simple</a></li>
							</ul>
						</div>
						...
						<div class="col-sm-5">
							<ul class="navigation right-nav">
								...
								<li><a href="gallery-single.html">Galerías</a></li>
	...
	<div id="slider" class="flexslider loading">
		<ul class="slides">
			<li style="background: url('http://www.cssigniter.com/preview/santorini/files/2014/03/slider_1.jpg') no-repeat center center">
			...
			<li style="background: url('http://www.cssigniter.com/preview/santorini/files/2014/03/slider_2.jpg') no-repeat center center">
				<div class="slide-info">
					<h2 class="slide-title">HOSTAL LUZ MARIA</h2>
					<p class="slide-subtitle">Desde &dollar;15 / día.</p>

					<a class="btn slide-more" href="">Ver Más.</a>
				</div>
			</li>
			<li style="background: url('http://www.cssigniter.com/preview/santorini/files/2014/03/hero3.jpg') no-repeat center center">
				<div class="slide-info">
					<h2 class="slide-title">¡Excelente servicio!</h2>
								...
								<div class="widget">
									...
									<div class="item">
										...
										<div class="item-content">
											<a class="item-title btn" href="">item title.</a>
										</div>
									</div>
