...
<head>
	...
	================================================== -->
	<meta charset="utf-8">
	<title>Room Page &ndash; Santorini</title>
...
<div id="mobile-bar">
	...
	<h1 class="mob-title">Room Page</h1>
</div>
		...
		<div class="row">
			<div class="col-lg-10 col-lg-offset-1">
				...
				<div class="room-slider flexslider">
					<ul class="slides">
						<li>
							<a data-rel="prettyPhoto[gal]" href="http://www.cssigniter.com/sample_content/sample_image.jpg"><img src='http://placehold.it/925x465' width='925' height='465' alt='Placeholder Image' /></a>
						</li>
						<li>
							<a data-rel="prettyPhoto[gal]" href="http://www.cssigniter.com/sample_content/sample_image.jpg"><img src='http://placehold.it/925x465' width='925' height='465' alt='Placeholder Image' /></a>
						</li>
...
<div class="booking-inpage" style="background: url('http://placehold.it/1920x350') no-repeat center center">
	<div class="container">
		<div class="row">
			<div class="col-lg-10 col-lg-offset-1">
					...
					<nav class="nav row">
						<div class="col-sm-5">
							<ul class="navigation left-nav">
								...
								<li class='current'><a class='current' href="room.html">Single Room</a></li>
							</ul>
						</div>
