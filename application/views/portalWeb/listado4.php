...
<head>
	...
	================================================== -->
	<meta charset="utf-8">
	<title>Listing Template &ndash; Santorini</title>
...
<div id="mobile-bar">
	...
	<h1 class="mob-title">Listing Template</h1>
</div>
				...
				<div class="col-lg-10 col-lg-offset-1">
					...
					<div id="mobilemenu">
						<ul>
							...
							<li class='current'><a class='current' href="listing-4col.html">Listing 4 Columns</a></li>
					...
					<div class="col-md-3 col-sm-6">
							...
							<div class="item">
								...
								<div class="item-content">
									...
									<p class="item-sub">from &dollar;99 / night</p>
								</div>
							</div>
