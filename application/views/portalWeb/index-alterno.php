...
<head>
	...
	================================================== -->
	<meta charset="utf-8">
	<title>Alternative Home &ndash; Santorini</title>
...
<div id="mobile-bar">
	...
	<h1 class="mob-title">Alternative Home</h1>
</div>
					...
					<nav class="nav row">
						<div class="col-sm-5">
							<ul class="navigation left-nav">
								...
								<li class='current'><a class='current' href="index_alt.html">Home 2</a></li>
		...
		<div class="row">
			<div class="col-lg-10 col-lg-offset-1">
				<div id="slider" class="flexslider loading">
					<ul class="slides">
						<li style="background: url('http://placehold.it/950x640') no-repeat center center">
							<div class="slide-info">
								<h2 class="slide-title">Live your myth in Greece</h2>
								<p class="slide-subtitle">from only &dollar;125 / day.</p>

								<a class="btn slide-more" href="">explore.</a>
							</div>
						</li>
						<li style="background: url('http://placehold.it/950x640') no-repeat center center">
							<div class="slide-info">
						...
						<div class="row">
							<div class="col-sm-8">
								...
								<article class="entry">
									...
									<h1 class="entry-title"><a href="single.html">Santorini: Five reasons to visit the beautiful Greek island</a></h1>
